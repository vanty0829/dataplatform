...
# rm -f /root/ranger-${RANGER_VERSION}-admin/ews/lib/lucene-core-*.jar
# wget -qO /root/ranger-${RANGER_VERSION}-admin/ews/lib/lucene-core-8.7.0.jar https://repo1.maven.org/maven2/org/apache/lucene/lucene-core/8.7.0/lucene-core-8.7.0.jar
